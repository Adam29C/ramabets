                ...
                <tr key={item1.id}>
                  ...
                  {item1.data.map((nestedItem) => (
                    <td key={nestedItem.id} className="cc">
                      ...
                      >
                        <span className="cp">
                          {nestedItem.relatedData[0] && nestedItem.relatedData[0].winningDigit}
                        </span>
                        <span className="cp">
                        ...
                        <span className="cp">
                          {nestedItem.relatedData[1] && nestedItem.relatedData[1].winningDigit}
                        </span>
                      </div>
                    </td>
                  ))}
